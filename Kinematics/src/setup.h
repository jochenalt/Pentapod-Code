...
enum NavigationStatusType { NavPending=0, 	 	// The goal has yet to be processed by the action server
							...
							NavRejected = 3, 	// The goal was rejected by the action server without being processed, because the goal was unattainable or invalid (Terminal State)
							NavPreempting = 4, 	// The goal received a cancel request after it started executing and has not yet completed execution
