...
// add a vector to a pose by considering the applied pose as transformation(translate first, then rotate)
...
Pose Pose::concatInverseTransformation(const Pose& sub) const {
		Pose  result;
